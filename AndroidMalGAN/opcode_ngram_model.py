        ...
        for bb_model in bb_models:
            ...
            if RAY_TUNE:
                search_space = {
                    ...
                    "g_2": [1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000],
                    "g_3": [500, 550, 600, 650, 700, 750, 800, 850, 900, 950, 1000],
                    "c_1": [500, 550, 600, 650, 700, 750, 800, 850, 900, 950, 1000],
                    "c_2": [200, 250, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750],
                    "c_3": [50, 100, 150, 200, 250, 300, 350, 400, 450, 500, 550],
